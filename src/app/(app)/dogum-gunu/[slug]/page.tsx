...
const dacia = async ({ params }: PageProps) => {
                ...
                <div className="page-header-content">
                  <div className="page-header-content-inner">
                    ...
                    <ul className="breadcrumb">
                      ...
                      <li>
                        <a href="index.html">dogum-gunu</a>
                      </li>
                  ...
                  <div className="sidebar-item">
                    ...
                    <div className="sidebar-body">
                      <ul className="sidebar-list">
                        ...
                        <li>
                          <Link href="/gonderime-gore/sevgiliye">
                            Sevgiliye
                          </Link>
                        </li>
                        <li>
                          <Link href="/gonderime-gore/yildonumu">
                            Yıldönümü
                          </Link>
                        </li>
                        <li>
                      ...
                      <div key={product.id} className="col-sm-6 col-lg-4">
                        <div className="product-item">
                          <div className="product-item__thumb">
                            <Link href={`/dogum-gunu/${slug}/${product.url}`}>
                              <img
                          ...
                          <div className="product-item__content">
                            <div className="product-item__info">
                              <h4 className="title">
                                <Link
                                  href={`/dogum-gunu/${slug}/${product.url}`}
                                >
                                  {product.title}
                                </Link>
                              </h4>
