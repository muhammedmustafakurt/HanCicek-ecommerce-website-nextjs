...
// Modify PageProps to reflect the resolved params
interface PageProps {
  params: Promise<{ slug: string }>;
}

const Coksatanlar = async ({ params }: PageProps) => {
                  ...
                  <div className="sidebar-item">
                    ...
                    <div className="sidebar-body">
                      <ul className="sidebar-list">
                        <li>
                          <Link href="/coksatanlar/IndrimdekiUrunler">
                            İndirimdeki ürünler
                          </Link>
                        </li>
                      </ul>
                      ...
                      <div key={product.id} className="col-sm-6 col-lg-4">
                        <div className="product-item">
                          <div className="product-item__thumb">
                            <Link href={`/coksatanlar/${slug}/${product.url}`}>
                              <img
                          ...
                          <div className="product-item__content">
                            <div className="product-item__info">
                              <h4 className="title">
                                <Link
                                  href={`/coksatanlar/${slug}/${product.url}`}
                                >
                                  {product.title}
                                </Link>
                              </h4>
